        ...
        <div class="col s12 m8 l8">
            <div class="card">
                <div class="card-move-up waves-effect waves-block waves-light">
                    <div class="move-up grey darken-2">
                        <div>
        ...
        <div class="col s12 m6 l4">
            <div id="profile-card" class="card">
                <div class="card-image waves-effect waves-block waves-light">
                    <img class="activator" src="<?php echo base_url();?>_assets/material-back/images/user-bg.jpg" alt="user background">
                </div>
                <div class="card-content">
                    <img src="<?php echo base_url();?>_assets/material-back/images/avatar.jpg" alt="" class="circle responsive-img activator card-profile-image">
